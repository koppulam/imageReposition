# ngImageCrop is an module which helps to select an image and re position/zoomin/zoomout and get the image position/zoomin/zoomout
...
Clone therepository using [git][git]:
...
```bash
git clone --depth=1 ##GIT repo location <your-project-name>
```
