...
function Cropper(options) {
  ...
  if (this.options.cropCallback) {
    this.events.on('Cropped', function(base64) {
      //this.getDimensions()
      this.options.cropCallback(this.getDimensions());
    }.bind(this));
  }
...
Cropper.prototype.setDimensions = function() {
  ...
  // Wrapper.
  this.elements.wrapper.style.height = this.options.height + 'px';
...
Cropper.prototype.getDimensions = function() {
  return {
    container : {
    ...
    wrapper: {
      width: this.elements.wrapper.style.width,
      height: this.elements.wrapper.style.height,
    }
  };
};
...
Cropper.prototype.cropHandler = function() {
 ...
 // var base64 = canvas.toDataURL('image/jpeg');
  this.events.triggerHandler('Cropped', "");
  return "";
};
 ...
 */
Cropper.prototype.events = function() {
  var _triggers = {};
